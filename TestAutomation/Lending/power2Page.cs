...
{
    class power2Page : FossaPageBase
    {
        public power2Page(IWebDriver driver, Dictionary<string, string> testData)
        ...
        public override IFormField[][] ValidQFSteps
        {
            get
            {
                ...
                // STEP - Type Of Vehicle 
                Steps[2] = Step(
                                new FossaField(SelectByText,"vehicle-body-type","VehicleType"),
                                new FossaField(Wait, "Wait"));

                // STEP - Estimated Price Purchase
                Steps[3] = Step(
                                new FossaField(Fill, "estimated-purchase-price", "EstimatedPurchasePrice"),
                                new FossaField(Wait, "Wait"));
                ...
                // STEP - Desired Loan Term
                Steps[5] = Step(
                                new FossaField(AutoAdvance(ClickElement), By.XPath("//div[contains(text(),'" + testData["AutoLoanTerm"] + "')]")),
                                new FossaField(GetAngularQFormUID, "power2"),
                                new FossaField(Wait, "Wait"));

                // STEP - Desired Monthly Payment
                Steps[6] = Step(
                ...
                // STEP - Any Bankruptcy In The Past 7 Years?                
                if (testData["BankruptcyHistory"].Equals("N", StringComparison.OrdinalIgnoreCase)
                            || testData["BankruptcyHistory"].Equals("", StringComparison.OrdinalIgnoreCase))
                {
                    Steps[stepNum] = Step(
                ...
                // STEP - What's Your Employment Status 
                Steps[stepNum] = Step(
                ...
                // STEP - Your Pre-tax Yearly Income
                ...
                // STEP - How Long Have You Lived Here?
                Steps[stepNum] = Step(
                ...
                // STEP - Alternate Phone Number 20
                Steps[stepNum] = Step(
