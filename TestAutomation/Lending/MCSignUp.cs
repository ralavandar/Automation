...
namespace TestAutomation.LendingTree
{
    public class mcSignUp : PageBase
    {
        ...
        public void PopulateDateofBirth(string dobMonth, string dobDay, string dobYear)
        {
            ...
            SelectElement Month = new SelectElement(mcSignUpDriver.FindElement(By.Id("dobMonth")));
            SelectElement Day = new SelectElement(mcSignUpDriver.FindElement(By.Id("dobDay")));
            SelectElement Year = new SelectElement(mcSignUpDriver.FindElement(By.Id("dobYear")));
        ...
        public void VerifyFreeCreditSignUpSuccess(Dictionary<string, string> testData)
        {
            ...
            if (success == true)
            {
                Common.ReportEvent(Common.PASS, String.Format("Test Case Name: {0} -- SUCCESSFULLY displayed credit report for {1} {2}",
                    testData["TestCaseName"], testData["ConsumerFirstName"], testData["ConsumerLastName"]));
            }
            else
            {
                Common.ReportEvent(Common.FAIL, String.Format("Test Case Name: {0} -- FAILED TO display credit report for {1} {2}",
                    testData["TestCaseName"], testData["ConsumerFirstName"], testData["ConsumerLastName"]));
        ...
        public void CompleteFreeCreditSignupPII(Dictionary<string, string> testData)
        {
            ...
            //Sign Up Step 2
            stepFound = VerifyMCSignUpStep("step/2/");
            if (stepFound == true)
            {
