...
{
    class rv2Page : FossaPageBase
    {
	        public rv2Page(IWebDriver driver, Dictionary<string, string> testData)
        ...
        public override IFormField[][] ValidQFSteps
        {
            get
            {
                ...
                // Add a steps if RV Loan Type is 'Used Car Purchase' to accomodate 'From Whom Are You Buying?', 'Found Vehicle?' and 'Milage'.
                //Add a step if RV Loan Type is 'Refinance' to accomodate VIN etc
                ...
                Steps[2] = Step(
                                ...
                                new FossaField(GetAngularQFormUID, "rv2"),
                                new FossaField(Wait, "Wait"));                
