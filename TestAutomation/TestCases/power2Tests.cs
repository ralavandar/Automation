...
{
    [TestFixture]
    class power2Tests : SeleniumTestBase
    {
        public IWebDriver driver;
        private const String strTableName = "tTestData_Auto";
        private power2Page power2;
        ...
        public void SetupTest()
        {
            ...
            power2 = new power2Page(driver, testData);
        ...
        [Test]
        public void power2_01_NewPurchase()
        {
        ...
        [Test]
        public void power2_02_UsedPurchase()
        {
            // Fill out and submit a QF
            power2.FillOutValidQF();
            FinishTest();
        ...
        private void FinishTest()
        {
            ...
            Validation.IsTrue(VerifytQFormRecord(power2.strQFormUID));
