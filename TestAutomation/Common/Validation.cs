...
namespace TestAutomation
{
    class Validation
    {
        ...
        {
            public static string VQF = "13C8A585-586E-4D9D-B121-3AFBFC3D0005";
            // TODO remove this VQF variable when I am able to get the real QF passed into reporteventaudit method
            ...
            public static Boolean AreEqual(Object expected, Object actual, String comparisonName)
            {
                ...
                {
                    Assert.AreEqual(expected, actual);
                    Common.ReportEventAudit(Common.PASS, String.Format
                        ("The {0} comparison passed.  Expected: \"{1}\".  Actual: \"{2}\".", comparisonName, expected, actual), VQF);
                    return true;
                ...
                {
                    Common.ReportEventAudit(Common.FAIL, String.Format
                        ("The {0} comparison failed.  Expected: \"{1}\".  Actual: \"{2}\".", comparisonName, expected, actual), VQF);
                    return false;
            ...
            public static Boolean StringCompare(String strExpected, String strActual)
            {
                try
                {
                    Assert.AreEqual(strExpected, strActual);
                    Common.ReportEventAudit(Common.PASS, String.Format
                   ("The string comparison passed.  Expected: \"{0}\".  Actual: \"{1}\".", strExpected, strActual), VQF);
                ...
                {
                    Common.ReportEventAudit(Common.FAIL, String.Format
                        ("The string comparison failed.  Expected: \"{0}\".  Actual: \"{1}\".", strExpected, strActual), VQF);
                    return false;
            ...
            public static Boolean StringCompareRegEx(String strPattern, String strActual)
            {
                try
                {
                    StringAssert.IsMatch(strPattern, strActual);
                    Common.ReportEventAudit(Common.PASS, String.Format
                        ("The string comparison passed.  Expected: \"{0}\".  Actual: \"{1}\".", strPattern, strActual), VQF);
                    return true;
                }
                catch
                {
                    Common.ReportEventAudit(Common.FAIL, String.Format
                        ("The string comparison failed.  Expected: \"{0}\".  Actual: \"{1}\".", strPattern, strActual), VQF);
                    return false;
                }
            }
            ...
            public static Boolean VerifySelectedOption(IWebDriver driver, string strId, string strExpected)
            {
                ...
                try
                {
                    ...
                    Common.ReportEventAudit(Common.PASS, String.Format
                        ("The selected item for '{0}' matched the expected value.  Expected: \"{1}\".  Actual: \"{2}\".",
                            strId, strExpected, strActual), VQF);
                    return true;
                }
                catch
                {
                    Common.ReportEventAudit(Common.FAIL, String.Format
                        ("The selected item for '{0}' DID NOT MATCH the expected value.  Expected: \"{1}\".  "
                        + "Actual: \"{2}\".", strId, strExpected, strActual), VQF);
                    return false;
                }
            }
            ...
            public static Boolean VerifyDropdownListAtPosition(IWebDriver driver, String strId, Int32 index, String strExpected)
            {
                ...
                try
                {
                    ...
                    Common.ReportEventAudit(Common.PASS, String.Format
                        ("The {0} dropdown option at index {1} matched the expected value.  Expected: \"{2}\".  "
                        + "Actual: \"{3}\".", strId, index, strExpected, strActual), VQF);
                    return true;
                }
                catch
                {
            ...
            public static Boolean IsTrue(Boolean booleanCondition, string assertString)
            {
                try
                {
                    Assert.IsTrue(booleanCondition);
                    Common.ReportEventAudit(Common.PASS, String.Format
                        ("Assertion \"{0}\" passed.  Expected true, got true", assertString), VQF);
                    return true;
                }
                catch
                {
                    Common.ReportEventAudit(Common.FAIL, String.Format
                        ("Assertion \"{0}\" failed.  Expected true, got false", assertString), VQF);
                    return false;
                }
            }
